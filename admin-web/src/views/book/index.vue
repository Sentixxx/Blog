<template>
    <div id="book">
        ...
        <div class="book-info-container">
            <el-dialog v-model="bookInfoVisible" width="800" :title="currentData.book_name">
                <div class="book-info-dialog">
                    <el-row>
                        <!-- 图书封面 -->
                        <el-col :span="8" class="book-cover">
                            <el-image
                                :src="currentData.book_pic"
                                fit="cover"
                                v-if="currentData.book_pic"
                            />
                            <el-image
                                src="https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg"
                                fit="cover"
                                ...
                                v-else
                            />
                            <div>Stock: {{ currentData.book_cur_stock_num }}</div>
                        </el-col>

                        <!-- 图书简介 -->
                        <el-col :span="16" class="book-introduction">
                            <p>{{ currentData.book_introduce }}</p>
                            <el-divider />
                            <h3>{{ currentData.book_author }}</h3>
                            <h3>ISBN: {{ currentData.book_isbn_code }}</h3>
                            <h3>Press: {{ currentData.book_press }}</h3>
                        </el-col>
                    </el-row>
                </div>
            </el-dialog>
...
const currentData = ref<BookInfo>({
    book_id: 1,
    book_name: '',
    book_author: '',
    book_introduce: '',
